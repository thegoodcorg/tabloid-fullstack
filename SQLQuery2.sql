...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (12, 'mhurtado1', 'Michael', 'Hurtado', 'mhurtado1@berklee.edu', '2023-04-19', null, 2, 'O4m6KjjPITSJeTGm3rJMAHDuWTr2');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (13, 'mfields1', 'Madison', 'Fields', 'madsfields@gmail.com', '2023-04-19', null, 1, '1TgGMsXdvoYO4NEKVfsnJhov4Yu2');
